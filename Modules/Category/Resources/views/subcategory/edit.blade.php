...
@section('content')
    <div class="container-fluid">
        <section class="d-flex justify-content-between">
            <h1 class="h3 mb-2 text-gray-800">ویرایش زیر دسته</h1>
            <a href="{{ route('subcategories.index') }}" class="btn btn-info" tooltip="انصراف" flow="up"
               title="انصراف"><i class="fa fa-arrow-left"></i></a>
        </section>
        <div class="card shadow mb-4 mt-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"> ویرایش زیر دسته {{ $subcategory->title }}</h6>
            </div>
            <div class="card-body">
                <form class="form" action="{{ route('subcategories.update', $subcategory->slug) }}" method="post">
                    @csrf
                    @method('PUT')

...
@section('title', 'افزودن آیتم های بخش تماس با ما')
@section('content')
    <div class="container-fluid">
        <section class="d-flex justify-content-between">
            <h1 class="h3 mb-2 text-gray-800">افزودن آیتم های بخش تماس با ما</h1>
            <a href="{{ route('contact.index') }}" class="btn btn-info" tooltip="انصراف" flow="up" title="انصراف">
                <i class="fa fa-arrow-left"></i></a>
        </section>
        <div class="card shadow mb-4 mt-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">ایجاد آیتم ها</h6>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="email" class="form-control" name="email" id="email"
                                       ...
                                       value="{{ old('email', optional($tag ?? null)->email) }}"
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="phone" id="phone"
                                       ...
                                       value="{{ old('phone', optional($tag ?? null)->phone) }}"
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="mobile" id="mobile"
                                       ...
                                       value="{{ old('mobile', optional($tag ?? null)->mobile) }}"
